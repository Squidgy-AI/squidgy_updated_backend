-- SIMPLE DATABASE UPDATE FOR BUSINESS SETUP
-- Run these statements one by one if you encounter any issues

-- Step 1: Add highlevel_tokens column to existing table
ALTER TABLE public.squidgy_agent_business_setup 
ADD COLUMN IF NOT EXISTS highlevel_tokens jsonb DEFAULT '{}'::jsonb;

-- Step 2: Update setup_type constraints
ALTER TABLE public.squidgy_agent_business_setup 
...
-- Step 3: Create business information table
